...
owners = [538533547145822209,900421898108821564,995000644660383764] 
...
async def on_ready():
    ...
    await bot.change_presence(status=discord.Status.idle,activity=discord.Activity(type=discord.ActivityType.watching, name=f"{len(bot.users)} users"))
    print("I am Ready")
